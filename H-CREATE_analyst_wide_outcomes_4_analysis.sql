...
WHERE phase1_msg_freq_rand = 'TM+' AND phase1_optout_text_hrts_GMT is null AND phase1_responseYES_hrts_GMT 
	is null AND phase1_tm5_sent_hrts_GMT is null AND phase1_optOut_InitialEmail_hrts_GMT is null)
/**/
